...
#define SWIG_init    boot_wiringpi

#define SWIG_name   "wiringpic::boot_wiringpi"
#define SWIG_prefix "wiringpic::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_wiringpi_var::
class _wrap_wiringpi_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_wiringPiGpioMode) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: wiringPiGpioMode(mode);");
    }
...
XS(_wrap_pullUpDnControl) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: pullUpDnControl(pin,pud);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_pinMode) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: pinMode(pin,mode);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_digitalWrite) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: digitalWrite(pin,value);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_pwmWrite) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: pwmWrite(pin,value);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_digitalRead) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: digitalRead(pin);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_shiftOut) {
  {
    ...
    if ((items < 4) || (items > 4)) {
      SWIG_croak("Usage: shiftOut(dPin,cPin,order,val);");
    }
...
XS(_wrap_shiftIn) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: shiftIn(dPin,cPin,order);");
    }
    ecode1 = SWIG_AsVal_unsigned_SS_char SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialOpen) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: serialOpen(device,baud);");
    }
...
XS(_wrap_serialClose) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: serialClose(fd);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialPutchar) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: serialPutchar(fd,c);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialPuts) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: serialPuts(fd,s);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialDataAvail) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: serialDataAvail(fd);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialGetchar) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: serialGetchar(fd);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_serialPrintf) {
  {
    ...
    if (items < 2) {
      SWIG_croak("Usage: serialPrintf(fd,message,...);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
{"wiringpic::digitalWrite", _wrap_digitalWrite},
{"wiringpic::pwmWrite", _wrap_pwmWrite},
...
{"wiringpic::serialPuts", _wrap_serialPuts},
{"wiringpic::serialDataAvail", _wrap_serialDataAvail},
{"wiringpic::serialGetchar", _wrap_serialGetchar},
{"wiringpic::serialPrintf", _wrap_serialPrintf},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
